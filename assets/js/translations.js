...
const translations = {
    en: {
        ...
        srv_2_title: "Online Catalog & E-Commerce", srv_2_desc: "Open your store 24/7. E-commerce solutions with shopping carts, payment gateway integrations, and inventory management.",
        srv_2_f1: "Payment Gateway Integration", srv_2_f2: "Automated Inventory", srv_2_f3: "Seamless Checkout Process",
        srv_3_title: "Custom Web Apps", srv_3_desc: "Custom-built web applications and information systems designed specifically to solve your unique operational business problems.",
        srv_3_f1: "Scalable Database Architecture", srv_3_f2: "Centralized Internal System", srv_3_f3: "External API Integration",
        srv_4_title: "Tell Us Your Business Needs.", srv_4_desc: "Tell us your website or app needs here, and get a free technical consultation!",
        srv_5_title: "UI/UX Redesign", srv_5_desc: "Have a rigid old website? We revamp the interface to be highly modern, aesthetic, and centered on user convenience.",
        srv_4_f1: "In-Depth User Research", srv_4_f2: "High-Fidelity Prototypes", srv_4_f3: "Smooth Animations",
    ...
    id: {
        ...
        srv_2_title: "Katalog Online & E-Commerce", srv_2_desc: "Buka toko Anda 24/7. Solusi website jualan dengan fitur keranjang belanja, integrasi payment gateway, dan manajemen stok.",
        srv_2_f1: "Integrasi Payment Gateway", srv_2_f2: "Manajemen Stok Otomatis", srv_2_f3: "Checkout Super Mulus",
        srv_3_title: "Custom Web App", srv_3_desc: "Sistem informasi dan aplikasi berbasis web yang dirancang khusus untuk memecahkan masalah operasional bisnis Anda yang unik.",
        srv_3_f1: "Arsitektur Database Skalabel", srv_3_f2: "Sistem Internal Terpusat", srv_3_f3: "Integrasi API Eksternal",
        srv_4_title: "Ceritakan Kebutuhan Bisnis Anda.", srv_4_desc: "Ceritakan kebutuhan website/aplikasi Anda di sini, dan dapatkan konsultasi arsitektur gratis!",
        srv_5_title: "UI/UX Redesign", srv_5_desc: "Punya website lama yang kaku? Kami poles ulang antarmukanya menjadi sangat modern, estetik, dan berpusat pada kenyamanan pengguna.",
        srv_4_f1: "Riset Pengguna Mendalam", srv_4_f2: "Prototipe Figma Resolusi Tinggi", srv_4_f3: "Interaksi & Animasi Halus",
